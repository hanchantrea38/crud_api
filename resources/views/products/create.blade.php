        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            <form action="{{ route('products.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" id="name" name="name" value="{{ old('name') }}" required>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" step="0.01" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" id="price" name="price" value="{{ old('price') }}" required>
                    </div>
                    <div>
                        <label for="qty" class="block text-gray-700 font-semibold mb-2">Quantity</label>
                        <input type="number" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" id="qty" name="qty" value="{{ old('qty') }}" required>
                    </div>
                </div>
